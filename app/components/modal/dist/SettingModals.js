...
var InfoUserModal = function (_a) {
    ...
    var _c = react_1.useState("general"), currentTab = _c[0], setCurrentTab = _c[1];
        ...
        react_1["default"].createElement("div", { onClick: handleModalContentClick, className: "fixed top-0 left-0 right-0 bottom-0 inset-0 flex  pt-[60px] ml-[300px] pb-[60px]  \n    }\n    z-30" },
            ...
            react_1["default"].createElement("div", { className: "bg-white w-[45%] relative pt-9 p-6" },
                ...
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("h1", null, "M\u1EADt kh\u1EA9u \u0111\u0103ng nh\u1EADp")),
                    react_1["default"].createElement("div", { className: " mt-4 cursor-pointer hover:bg-neutral-200 p-2 bg-slate-200 w-[200px]" },
                        react_1["default"].createElement("h1", null, "\u0110\u1ED5i m\u1EADt kh\u1EA9u")))),
            react_1["default"].createElement("div", { className: "fixed top-0 left-0 right-0 bottom-0 bg-slate-500" },
                currentTab === "general" && react_1["default"].createElement(GeneralModal_1["default"], null),
                currentTab === "privacy" && react_1["default"].createElement(ChangePasswordModal_1["default"], null)))));
};
