...
function FriendListItem({ ID, avatar, fullName }: IProps) {
  ...
  return (
    <div>
      <div className="flex border-2 p-2 mt-3 hover:cursor-pointer hover:border-gray-400 justify-items-center space-x-[800px] relative">
        ...
        <div className="absolute right-16">
          ...
          <div className="ml-[-150px] mt-10">
            {isOpenUnFriendModal && (
              <UnfriendModals ID={ID} onClose={closeModal} />
            )}
          </div>
        </div>
        {/* show modal */}
