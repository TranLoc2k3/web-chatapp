import ContactPage from "@/app/dashboard/contact/layout";
...
const ContactTab: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div>
        <Link href={`/dashboard/contact/friend-list`} key={'friend-list'}
        ...
        <Link href={`/dashboard/contact/friend-group`} key={'friend-group'}
        ...
        <Link href={`/dashboard/contact/friend-request`} key={'friend-request'}
          className={`flex p-5 hover:bg-slate-200 ${
        ...
        >
          <Mail />
          <h3 className="ml-2">Lời mời kết bạn</h3>
        </Link>
      </div>
    </div>
  );
